...
interface SuggestedPromptsProps {
  ...
  isLoading: boolean;
  conversationId?: string; // To detect "Everything Else" tab
}
...
const SuggestedPrompts: React.FC<SuggestedPromptsProps> = ({ 
  ...
  const isEverythingElse = conversationId === 'everything-else';
  
  // For Everything Else tab:
  ...
  const isShowingNewsPrompts = isEverythingElse && 
