...
class TaskCompletionPromptingService extends BaseService {
...
let _taskCompletionPromptingService: TaskCompletionPromptingService | null = null;
export const taskCompletionPromptingService = (() => {
  if (!_taskCompletionPromptingService) {
    _taskCompletionPromptingService = ServiceFactory.create(TaskCompletionPromptingService);
  }
  return _taskCompletionPromptingService;
})();
