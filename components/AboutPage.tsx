...
const AboutPage: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="mt-4 text-[#A3A3A3] leading-relaxed">During my time studying Service Design at the Royal College of Art (RCA) in London, this frustration grew into a purpose. I wanted to build a tool that respected the player and their experience—a companion that could provide the perfect nudge without giving away the destination.</p>
