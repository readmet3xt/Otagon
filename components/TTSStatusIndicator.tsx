...
// ========================================
// Provides visual feedback about TTS availability and status

import React, { useState, useEffect } from 'react';
import { enhancedErrorHandlingService, TTSErrorContext } from '../services/enhancedErrorHandlingService';
...
export const TTSStatusIndicator: React.FC<{
  ...
  const checkTTSAvailability = async () => {
    try {
      ...
      testUtterance.onerror = async (e) => {
        try {
          const errorContext: TTSErrorContext = {
            operation: 'tts_test',
            component: 'TTSStatusIndicator',
            additionalData: { testError: e }
          };
          
          const errorInfo = await enhancedErrorHandlingService.handleTTSError(e, errorContext);
