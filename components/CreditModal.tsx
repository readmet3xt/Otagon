...
const CreditModal: React.FC<CreditModalProps> = ({ onClose, onUpgrade, usage }) => {
  const { textCount, textLimit, imageCount, imageLimit, tier } = usage;
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in" onClick={onClose}>
      ...
      >
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4 bg-[#2E2E2E]/60 p-4 rounded-lg">
