...
const RefundPolicyPage: React.FC = () => {
  return (
    <>
      ...
      <p>Thank you for being a part of the Otagon community. Our goal is to provide a simple and fair experience for all our users.</p>

      <h2 className="text-2xl font-bold text-white mt-8 mb-4">Subscription Cancellation</h2>
      <p>You can cancel your Otagon Pro or Pro Vanguard subscription at any time. Your subscription will remain active until the end of your current billing period (monthly or yearly), and you will not be charged again. You can manage your subscription through your account settings.</p>

      <h2 className="text-2xl font-bold text-white mt-8 mb-4">Refund Eligibility</h2>
      <p>Otagon subscriptions are non-refundable.</p>
      ...
      <p>We believe in the value Otagon provides and encourage users to make the most of our Free tier to decide if a Pro subscription is right for them. This policy allows us, a small team based in Hyderabad, India, to manage our resources effectively and continue building the best possible spoiler-free gaming companion for our global community.</p>

      <h2 className="text-2xl font-bold text-white mt-8 mb-4">Contact Us</h2>
      <p>If you have any questions about this policy, please contact us at <a href="mailto:support@otagon.app" className="text-[#FFAB40] hover:underline">support@otagon.app</a>.</p>
    </>
  );
};
